...
class MediumASR(nn.Module):
    def __init__(self, input_dim, output_dim, dropout=0.2):
        ...
        self.conv1 = nn.Conv2d(1, 64, kernel_size=(11, 41), stride=(2, 2), padding=(5, 20), bias=False)
        self.bn1 = nn.BatchNorm2d(64)
        self.conv2 = nn.Conv2d(64, 64, kernel_size=(11, 21), stride=(1, 2), padding=(5, 10), bias=False)
        self.bn2 = nn.BatchNorm2d(64)

        # RNN Layers
        self.lstm1 = nn.LSTM(160 * 2, 128, bidirectional=True, batch_first=True)
